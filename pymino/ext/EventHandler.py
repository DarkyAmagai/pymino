...
from .http_client import httpx_handler
...
class EventHandler:
    ...
    def on_ready(self):
        """
        `on_ready` is a decorator that runs when the bot is ready.
        ...
        @bot.on_ready()
        def on_ready():
            print(f"{bot.profile.username} is online!")
    ...
    def command(self, name: str):
        """
        `command` is a decorator that handles commands.

...
class AsyncGlobal:
    ...
    async def fetch_user(self, userId: str) -> UserProfile:
        """
        ...
        >>> print(x.icon)
        """
        return UserProfile(await self.make_request(
            method = "GET",
            url = f"/g/s/user-profile/{userId}"
        ))

    @authenticated
    async def send_message(self, content: str, chatId: str, **kwargs) -> CMessage:
        """
        ...
        """
        return CMessage(await self.make_request(
            method="POST",
    ...
    async def edit_profile(
        ...
        **Example usage:**
        ...
        if icon: data['icon'] = await self.upload_image(icon)
        ...
        if backgroundImage:
            data["extensions"] = {
                "style": {
                    "backgroundMediaList": [
                        [100, await self.upload_image(backgroundImage), None, None, None]
                    ]
                }
            }
        if defaultBubbleId:
    ...
    async def start_chat(
        ...
        return ChatThread(
            await self.make_request(method="POST", url="/g/s/chat/thread", data=data)
        )


    @authenticated
    async def blocker_users(self, start: int = 0, size: int = 25) -> List[str]:
        """
    ...
    async def fetch_wall_comments(self, userId: str, sorting: str = "newest", start: int = 0, size: int = 25) -> CommentList:
        """
        ...
        **Example usage:**
        ...
        return CommentList(await self.make_request(
            method = "GET",
    ...
    @authenticated
    async def delete_message(self, chatId: str, messageId: str) -> ApiResponse:
        """
    ...
    async def edit_chat(
        ...
        **Example usage:**
        ...
        if doNotDisturb is not None:
            responses.append(ApiResponse(await self.make_request(
                method = "POST",
    ...
    @authenticated
    async def follow(self, userId: Union[str, list]) -> ApiResponse:
        """
    ...
    @authenticated
    async def fetch_chats(self, start: int = 0, size: int = 25) -> ChatThreadList:
        """
        ...
        **Example usage:**
        ...
        ...     print(thread.title)
        """
        return ChatThreadList(await self.make_request(
            method = "GET",
    ...
    @authenticated
    async def fetch_chat(self, chatId: str) -> ChatThread:
        """
        ...
        **Example usage:**
        ...
        ... print(chat.messages)
        """
        return ChatThread(await self.make_request(
            method = "GET",
            url = f"/g/s/chat/thread/{chatId}"
        ))
    ...
    @authenticated
    async def fetch_chat_users(self, chatId: str, start: int = 0, size: int = 25) -> CChatMembers:
        """
        ...
        **Example usage:**
        ...
        ...     print(member)
        """
        return CChatMembers(await self.make_request(
            method = "GET",
    ...
    @authenticated
    async def invite_to_chat(self, chatId: str, userId: Union[str, list]) -> ApiResponse:
        """
    ...
    @authenticated
    async def kick(self, chatId: str, userId: str, allowRejoin: bool = True) -> ApiResponse:
        """
    ...
    @authenticated
    async def fetch_messages(self, chatId: str, size: int = 25, pageToken: str = None) -> CMessages:
        """
        ...
        **Example usage:**
        ...
        if pageToken is not None:
            return CMessages(await self.make_request(
                method = "GET",
    ...
    @authenticated
    async def fetch_message(self, chatId: str, messageId: str) -> Message:
        """
        ...
        **Example usage:**
        ...
        """
        return Message(await self.make_request(
            method = "GET",
            url = f"/g/s/chat/thread/{chatId}/message/{messageId}"
        ))
    ...
    @authenticated
    async def search_community(self, aminoId: str) -> dict:
        """
    ...
    @authenticated
    async def fetch_followers(self, userId: str, start: int = 0, size: int = 25) -> UserProfileList:
        """
    ...
    @authenticated
    async def blocked_users(self, start: int = 0, size: int = 25):
        """
    ...
    @authenticated
    async def mark_as_read(self, chatId: str, messageId: str) -> ApiResponse:
        """
    ...
    @authenticated
    async def visit(self, userId: str) -> ApiResponse:
        """
    ...
    @authenticated
    async def block(self, userId: str) -> ApiResponse:
        """
        Blocks a user.
    ...
    @authenticated
    async def unblock(self, userId: str) -> ApiResponse:
        """
        Unblocks a user.
    ...
    @authenticated
    async def join_request(self, comId: str, message: str = None):
        """
    ...
    async def fetch_linked_communities(self, userId: str) -> list:
        """
    ...
    async def fetch_unlinked_communities(self, userId: str) -> list:
        """
    ...
    @authenticated
    async def reorder_linked_communities(self, comIds: List[int]) -> ApiResponse:
        """
    ...
    @authenticated
    async def add_linked_community(self, comId: int) -> ApiResponse:
        """
    ...
    @authenticated
    async def remove_linked_community(self, comId: int) -> ApiResponse:
        """
    ...
    @authenticated
    async def comment(self, message: str, userId: str = None, blogId: str = None, wikiId: str = None, replyTo: str = None) -> ApiResponse:
        """
    ...
    @authenticated
    async def delete_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None) -> ApiResponse:
        """
    ...
    @authenticated
    async def like_blog(self, blogId: Union[str, list] = None, wikiId: str = None) -> ApiResponse:
        """
    ...
    @authenticated
    async def unlike_blog(self, blogId: str = None, wikiId: str = None) -> ApiResponse:
        """
        ...
        **Example usage:**
        ...
        if blogId: return ApiResponse(await self.make_request(
                method = "DELETE",
                url = f"{self.api}/g/s/blog/{blogId}/g-vote?eventSource=UserProfileView"
            ))
        elif wikiId: return ApiResponse(await self.make_request(
                method = "DELETE",
    ...
    @authenticated
    async def like_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None) -> ApiResponse:
        """
    ...
    @authenticated
    async def unlike_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None) -> ApiResponse:
        """
    ...
    async def fetch_supported_languages(self) -> List[str]:
        """
    ...
    @authenticated
    async def fetch_ta_announcement(self, language: str = "en", start: int = 0, size: int = 25) -> dict:
        """
    ...
    @authenticated
    async def join_chat(self, chatId: str) -> ApiResponse:
        """
    ...
    @authenticated
    async def leave_chat(self, chatId: Union[str, List[str]]) -> ApiResponse:
        """
    ...
    @authenticated
    async def join_community(self, community_id: int, invitationId = None) -> ApiResponse:
        """
    ...
    @authenticated
    async def leave_community(self, community_id: int) -> ApiResponse:
        """
    ...
    async def fetch_community(self, community_id: int) -> CCommunity:
        """
        ...
        **Note:** This function can be used to fetch the community information for a community on Amino. The community
        ...
        other information.
        """
        return CCommunity(await self.make_request(
            method="GET",
    ...
    @authenticated
    async def joined_communities(self) -> CCommunityList:
        """
    ...
    async def fetch_object_id(self, link: str) -> str:
        ...
        **Example usage:**
        ...
        if not self.cache.get(KEY):
            self.cache.set(KEY, await self.make_request(
                method = "GET",
    ...
    async def fetch_available_communities(self, start: int = 0, size: int = 25, language: str = "en"):
        """
